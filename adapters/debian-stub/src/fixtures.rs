...
pub fn debian_family() -> DistributionFamily {
    ironmaint_testkit::fixtures::family("debian")
}

pub fn sid_release() -> DistributionRelease {
    ironmaint_testkit::fixtures::release("sid")
}
...
pub fn source_candidate() -> SourceCandidate {
    ironmaint_testkit::fixtures::source_candidate(debian_family(), sid_release())
}

pub fn release_candidate() -> ReleaseCandidate {
    ironmaint_testkit::fixtures::release_candidate(debian_family(), sid_release())
}
